...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    $limits=['publish'=>[60,3600],'media_upload_start'=>[30,3600],'media_upload_chunk'=>[2400,3600],'comment'=>[120,3600],'feed_read'=>[900,3600],'watch_source'=>[120,3600],'follow'=>[120,3600],'save'=>[240,3600],'live_message'=>[180,3600],'research_add'=>[120,3600],'transcript_edit'=>[60,3600]];
