...
$cognitiveFeed=$feedMode==='cognitive'?cognitive_feed_compose($pdo,$u,$chatTeams,4,28):['ready'=>$cognitiveReady,'sections'=>[],'total'=>0,'hidden_count'=>0,'ranking'=>''];$proactiveReady=proactive_intelligence_ready($pdo);if($proactiveReady&&$feedMode==='cognitive')proactive_intelligence_sync($pdo,$u,$cognitiveFeed);$proactiveBriefing=$proactiveReady?proactive_briefing($pdo,$u,3):['ready'=>false,'items'=>[],'count'=>0];
