...
<header class="topbar"><a class="brand" href="/admin/">Annotated Admin</a><nav><a class="active" href="/admin/users.php">Users</a><a href="/admin/packages.php">Packages</a><a href="/admin/ai.php">AI</a><a href="/admin/source-monitor.php">Sources</a><a href="/admin/moderation.php">Moderation</a></nav></header>
...
<td><strong><?=h((string)($x['package_name']?:'Account not initialized'))?></strong><?php if($x['monthly_ai_token_allowance']!==null):?><div class="meta"><?=h(number_format((int)$x['monthly_ai_token_allowance']))?> AI tokens / month</div><?php endif?><?php if((int)($x['member_limit']??1)>1):?><div class="meta">Up to <?=h((string)$x['member_limit'])?> account members</div><?php endif?></td>
