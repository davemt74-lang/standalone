...
function research_portfolio_compose(PDO $pdo,array $viewer,int $limit=40): array {
    if(!research_portfolio_ready($pdo))return ['ready'=>false,'projects'=>[],'summary'=>[]];$projects=research_portfolio_projects($pdo,$viewer,$limit);if(!$projects)return ['ready'=>true,'projects'=>[],'summary'=>['total'=>0,'needs_attention'=>0,'watch'=>0,'clear'=>0,'pinned'=>0,'assigned_reviews'=>0,'unresolved_impact'=>0,'pending_agent_actions'=>0,'automation_failures'=>0,'review_objections'=>0,'evidence_conflicts'=>0],'generated_at'=>date('Y-m-d H:i:s')];
