...
function action_center_kind_for_type(string $type): ?string {
    return match($type){
      ...
      'source_change','research_gap','research_conflict','related_conflict','review_stale','review_changes_requested','review_objection','change_impact','model_health_incident'=>'review',
