...
function admin_ui_sidebar(string $active='dashboard'): string {
    ...
    return $out.'</nav><div class="adminSidebarFoot"><span>Admin V2.0 · lineage V1.30 · V1.40 · V1.50 · V1.60 · V1.70 · V1.80 · V1.90</span><a href="/logout.php">Sign out</a></div></aside>';
}
