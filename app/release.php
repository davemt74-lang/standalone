...
function release_queue_health(PDO $pdo): array {
    $tables=['media'=>'media_jobs','transcription'=>'transcription_jobs','research_files'=>'research_file_jobs','research_transcription'=>'research_transcription_jobs','source_monitor'=>'source_monitor_jobs','ai'=>'ai_jobs','research_automation'=>'research_automation_runs','evaluation'=>'data_evaluation_runs','training'=>'data_training_jobs','post_training'=>'data_post_training_plans'];$out=[];
