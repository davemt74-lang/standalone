...
function release_worker_specs(): array {
    return [
      ...
      'research_files'=>['command'=>'php worker/research-file-worker.php','cadence'=>'continuous / every minute','stale_after'=>300],
      'research_transcription'=>['command'=>'php worker/research-transcription-worker.php','cadence'=>'continuous / every minute','stale_after'=>300],
      'research_retrieval'=>['command'=>'php worker/research-retrieval-worker.php','cadence'=>'continuous / every minute','stale_after'=>300],
      'research_autonomy'=>['command'=>'php worker/research-autonomy-worker.php','cadence'=>'continuous / every minute','stale_after'=>300],
      'research_monitor'=>['command'=>'php worker/research-monitor-worker.php','cadence'=>'continuous / every minute','stale_after'=>300],
      'research_tasks'=>['command'=>'php worker/research-task-worker.php','cadence'=>'continuous / every minute','stale_after'=>300],
      'research_programs'=>['command'=>'php worker/research-program-worker.php','cadence'=>'continuous / every minute','stale_after'=>300],
...
function release_queue_health(PDO $pdo): array {
    $tables=['media'=>'media_jobs','transcription'=>'transcription_jobs','research_files'=>'research_file_jobs','research_transcription'=>'research_transcription_jobs','research_retrieval'=>'research_retrieval_jobs','research_autonomy'=>'research_autonomy_jobs','research_monitor'=>'research_monitor_jobs','research_tasks'=>'research_task_jobs','research_programs'=>'research_program_runs','source_monitor'=>'source_monitor_jobs','ai'=>'ai_jobs','research_automation'=>'research_automation_runs','evaluation'=>'data_evaluation_runs','training'=>'data_training_jobs','post_training'=>'data_post_training_plans'];$out=[];
