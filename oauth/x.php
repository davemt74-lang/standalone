...
try{rate_limit_enforce($pdo,$config,'oauth_start_ip',rate_limit_subject_ip(),30,600);}catch(RateLimitExceeded $e){header('Retry-After: '.$e->retryAfter);http_response_code(429);exit('Too many sign-in attempts. Try again later.');}
