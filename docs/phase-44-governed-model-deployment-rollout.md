...
3. **Shadow** — records a temporary override with 0% served candidate traffic. Candidate responses are not user-visible.
...
- `shadow`: always returns the baseline model.
