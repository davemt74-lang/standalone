...
<?php foreach($members as $m):?><div class="sessionRow"><a class="profileMini" href="/profile.php?u=<?=h($m['username'])?>"><?=app_shell_avatar($m,'teamMiniAvatar')?><span><strong><?=h($m['display_name'])?></strong><small>@<?=h($m['username'])?> · <?=h(ucfirst($m['role']))?></small></span></a>
