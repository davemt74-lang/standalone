...
required=(
  ...
  app/release.php app/release-operations.php app/schema-health.php app/research-library.php app/research-agents.php api/research-agents.php assets/js/research-agent-shell.js research.php saved.php teams.php annotation.php profile.php
  ...
  database/schema.sql database/migrations/20260922_046_model_improvement_campaigns.sql database/migrations/20260922_047_research_agents.sql
...
if(($r["latest_migration"]??"")!=="20260922_047_research_agents.sql")throw new RuntimeException("Release manifest does not identify latest migration.");
