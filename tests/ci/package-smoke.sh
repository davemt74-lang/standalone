...
if(($r["latest_migration"]??"")!=="20260924_062_subscriptions_packages_accounts.sql")throw new RuntimeException("Release manifest does not identify latest migration.");
