...
required=(
  ...
  app/release.php app/release-operations.php app/schema-health.php app/research-library.php app/research-agents.php app/research-agent-workspace.php app/research-agent-workspace-ui.php app/research-retrieval.php app/research-autonomy.php api/research-agents.php api/research-workspace-objects.php api/research-workspace-upload.php api/research-retrieval.php api/research-autonomy.php research-workspace-file.php worker/research-file-worker.php worker/research-transcription-worker.php worker/research-retrieval-worker.php worker/research-autonomy-worker.php assets/js/research-agent-shell.js assets/js/research-agent-workspace-ui.js research.php saved.php teams.php annotation.php profile.php
  ...
  database/schema.sql database/migrations/20260922_046_model_improvement_campaigns.sql database/migrations/20260922_047_research_agents.sql database/migrations/20260923_048_research_agent_workspace_core.sql database/migrations/20260923_049_research_docs_floating_stickies.sql database/migrations/20260923_050_research_agent_desktop.sql database/migrations/20260923_051_research_desktop_uploads_recordings.sql database/migrations/20260923_052_unified_research_retrieval.sql database/migrations/20260923_053_autonomous_research_workspace.sql
  docs/RELEASE-V1.1-RC1.md docs/phase-49-release-candidate-operational-hardening.md docs/phase-51-research-docs-floating-stickies.md docs/phase-52-research-agent-desktop.md docs/phase-53-desktop-files-recordings.md docs/phase-54-unified-research-retrieval.md docs/phase-55-autonomous-research-workspace.md
...
if(($r["latest_migration"]??"")!=="20260923_053_autonomous_research_workspace.sql")throw new RuntimeException("Release manifest does not identify latest migration.");
