...
if(($r["latest_migration"]??"")!=="20260923_061_profile_public_identity_showcase.sql")throw new RuntimeException("Release manifest does not identify latest migration.");
