...
if(($r["latest_migration"]??"")!=="20260923_056_research_programs_recurring_intelligence.sql")throw new RuntimeException("Release manifest does not identify latest migration.");
