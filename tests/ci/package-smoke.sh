...
if(($r["latest_migration"]??"")!=="20260923_058_research_intelligence_portfolios_executive_briefing.sql")throw new RuntimeException("Release manifest does not identify latest migration.");
...
'
for file in home.php research.php research-monitoring.php research-tasks.php research-programs.php research-reviews.php research-publications.php research-intelligence-portfolios.php profile.php research-workspace-file.php app/research-library.php app/research-agents.php app/research-agent-workspace.php app/research-agent-workspace-ui.php api/research-agents.php api/research-workspace-objects.php api/research-workspace-upload.php api/research-retrieval.php api/research-autonomy.php api/research-monitoring.php api/research-tasks.php api/research-programs.php api/research-publications.php worker/research-file-worker.php worker/research-transcription-worker.php worker/research-retrieval-worker.php worker/research-autonomy-worker.php worker/research-monitor-worker.php worker/research-task-worker.php worker/research-program-worker.php app/research-retrieval.php app/research-autonomy.php app/research-monitoring.php app/research-tasks.php app/research-programs.php app/research-reviews.php app/research-publishing.php app/research-intelligence-portfolios.php api/research-intelligence-portfolios.php app/bootstrap.php app/runtime-compat.php app/schema-health.php app/release.php app/release-operations.php admin/system-health.php bin/release-preflight.php bin/release-backup.php bin/release-backup-verify.php bin/release-restore-plan.php; do php -l "$tmp/site/$file" >/dev/null; done
