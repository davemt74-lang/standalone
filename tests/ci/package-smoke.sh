...
if(($r["latest_migration"]??"")!=="20260923_060_vp3_account_connection_research_ingestion.sql")throw new RuntimeException("Release manifest does not identify latest migration.");
