...
required=(
  ...
  app/release.php app/release-operations.php app/schema-health.php app/research-library.php app/research-agents.php app/research-agent-workspace.php app/research-agent-workspace-ui.php app/research-retrieval.php app/research-autonomy.php app/research-monitoring.php app/research-tasks.php api/research-agents.php api/research-workspace-objects.php api/research-workspace-upload.php api/research-retrieval.php api/research-autonomy.php api/research-monitoring.php api/research-tasks.php research-workspace-file.php worker/research-file-worker.php worker/research-transcription-worker.php worker/research-retrieval-worker.php worker/research-autonomy-worker.php worker/research-monitor-worker.php worker/research-task-worker.php assets/js/research-agent-shell.js assets/js/research-agent-workspace-ui.js research.php research-monitoring.php research-tasks.php saved.php teams.php annotation.php profile.php
  ...
  database/schema.sql database/migrations/20260922_046_model_improvement_campaigns.sql database/migrations/20260922_047_research_agents.sql database/migrations/20260923_048_research_agent_workspace_core.sql database/migrations/20260923_049_research_docs_floating_stickies.sql database/migrations/20260923_050_research_agent_desktop.sql database/migrations/20260923_051_research_desktop_uploads_recordings.sql database/migrations/20260923_052_unified_research_retrieval.sql database/migrations/20260923_053_autonomous_research_workspace.sql database/migrations/20260923_055_research_tasks_plans_deliverables.sql database/migrations/20260923_055_research_tasks_plans_deliverables.sql
  docs/RELEASE-V1.1-RC1.md docs/phase-49-release-candidate-operational-hardening.md docs/phase-51-research-docs-floating-stickies.md docs/phase-52-research-agent-desktop.md docs/phase-53-desktop-files-recordings.md docs/phase-54-unified-research-retrieval.md docs/phase-55-autonomous-research-workspace.md docs/phase-56-continuous-research-monitoring.md docs/phase-57-research-tasks-plans-deliverables.md
...
if(($r["latest_migration"]??"")!=="20260923_055_research_tasks_plans_deliverables.sql")throw new RuntimeException("Release manifest does not identify latest migration.");
...
'
for file in home.php research.php research-monitoring.php research-tasks.php profile.php research-workspace-file.php app/research-library.php app/research-agents.php app/research-agent-workspace.php app/research-agent-workspace-ui.php api/research-agents.php api/research-workspace-objects.php api/research-workspace-upload.php api/research-retrieval.php api/research-autonomy.php api/research-monitoring.php api/research-tasks.php worker/research-file-worker.php worker/research-transcription-worker.php worker/research-retrieval-worker.php worker/research-autonomy-worker.php worker/research-monitor-worker.php worker/research-task-worker.php app/research-retrieval.php app/research-autonomy.php app/research-monitoring.php app/research-tasks.php app/bootstrap.php app/runtime-compat.php app/schema-health.php app/release.php app/release-operations.php admin/system-health.php bin/release-preflight.php bin/release-backup.php bin/release-backup-verify.php bin/release-restore-plan.php; do php -l "$tmp/site/$file" >/dev/null; done
