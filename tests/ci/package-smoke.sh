...
required=(
  ...
  docs/RELEASE-V1.1-RC1.md docs/phase-49-release-candidate-operational-hardening.md docs/phase-51-research-docs-floating-stickies.md docs/phase-52-research-agent-desktop.md
...
if(($r["latest_migration"]??"")!=="20260923_050_research_agent_desktop.sql")throw new RuntimeException("Release manifest does not identify latest migration.");
