...
db_tests=(
  ...
  tests/admin-v1-50-account-membership-db.php
  tests/admin-v1-60-billing-analytics-db.php
  tests/admin-v1-70-ai-overage-billing-db.php
  ...
  tests/admin-v2-20-support-operations-db.php
  tests/admin-v2-30-financial-reporting-db.php
  tests/admin-v2-40-customer-success-db.php
  ...
  tests/admin-v2-90-proactive-admin-agent-db.php
)
