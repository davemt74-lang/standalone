...
$must('app/agent-actions.php',[
 "'research.create_system_report'","research_system_report_generate","Create System Report"
...
$must('research-agent-knowledge.php',[
 'RESEARCH AGENT KNOWLEDGE','WHAT I KNOW','OPEN QUESTIONS','DISPUTED','KNOWLEDGE GRAPH','WHAT CHANGED','WORKING ON','SYSTEM REPORTS'
...
foreach(['Phase 67 — Unified Research Knowledge & System Reports','.researchKnowledgeGrid','.researchSystemReportTypes','.researchCanvasTopLink'] as $needle)if(!str_contains($css,$needle))$fail[]='Phase 67 CSS missing '.$needle;
