...
foreach(['data-research-library-filter="monitoring"','/assets/css/app.css?v=58.0','/assets/js/research-agent-workspace-ui.js?v=58.0'] as $needle)$must(str_contains($home,$needle),'Phase 56 Home/Library UI contract missing: '.$needle);
