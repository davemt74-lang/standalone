...
$historicalDbTests=[
    ...
    'tests/phase45-model-observability-db.php','tests/phase46-model-improvement-db.php','tests/phase47-model-campaign-db.php','tests/phase48-closed-loop-release-audit-db.php','tests/phase49-release-candidate-ops-db.php','tests/phase49-5-recent-build-hardening-db.php','tests/phase50-research-agent-workspace-db.php','tests/phase51-research-docs-stickies-db.php','tests/phase52-research-agent-desktop-db.php','tests/phase53-desktop-files-recordings-db.php',
];
