...
$policy=data_model_observability_policy_update($pdo,$admin,$deploymentId,[
 'enabled'=>'1','window_minutes'=>120,'min_samples'=>2,'max_failure_rate'=>0.10,'max_p95_latency_ms'=>60000,
...
p45((float)$metrics['failure_rate']>=0.5,'rolling health snapshot measures the observed failure rate');
