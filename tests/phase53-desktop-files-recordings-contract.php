...
$need('home.php','/assets/css/app.css?v=59.0','Phase 54 stylesheet must have a fresh cache key.');
$need('home.php','research-agent-workspace-ui.js?v=59.0','Phase 54 Desktop runtime must have a fresh cache key.');
