...
$need('home.php','/assets/css/app.css?v=58.0','Phase 54 stylesheet must have a fresh cache key.');
$need('home.php','research-agent-workspace-ui.js?v=58.0','Phase 54 Desktop runtime must have a fresh cache key.');
