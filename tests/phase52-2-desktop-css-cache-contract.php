...
foreach([
  '/assets/css/app.css?v=57.0'=>'Home must force-refresh the Phase 57 stylesheet.',
  '/assets/js/agent-chat.js?v=55.1'=>'Home must force-refresh the Phase 55.1 Agent Chat runtime.',
  '/assets/js/research-agent-workspace-ui.js?v=57.0'=>'Home must force-refresh the Phase 55.2 Research workspace runtime.',
