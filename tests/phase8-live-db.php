...
foreach([[$owner,'owner'],[$researcher,'researcher'],[$viewer,'viewer']] as [$u,$role])$pdo->prepare('INSERT INTO team_members(team_id,user_id,role) VALUES(?,?,?)')->execute([$teamId,$u['id'],$role]);
