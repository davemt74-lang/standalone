...
if(!str_contains($home,'/assets/css/app.css?v=56.0'))$fail[]='Home must request the Phase 55.2 CSS cache key.';
if(!str_contains($home,'/assets/js/research-agent-workspace-ui.js?v=56.0'))$fail[]='Home must request the Phase 55.3 workspace JS cache key.';
