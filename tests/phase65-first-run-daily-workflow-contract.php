...
foreach(["['agent','workspace','doc']","window.AnnotatedResearchWorkspace?.closeDesktop?.()","setModeFeed();"] as $needle)if(!str_contains($chat,$needle))$fail[]='Research Agent safe return-to-Home behavior missing '.$needle;
