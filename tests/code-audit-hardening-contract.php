...
$need('database/migrations/20260924_067_ai_quota_checkout_idempotency.sql','ai_usage_reservations','Migration 067 must persist per-run AI quota reservations.');
$need('database/migrations/20260924_067_ai_quota_checkout_idempotency.sql','stripe_checkout_sessions','Migration 067 must persist recoverable Stripe Checkout attempts.');
...
$need('.github/workflows/full-regression.yml','code-audit-upgrade-from-065.php','Phase gate must retain the shipped migration 065 to 066 rehearsal.');
$need('.github/workflows/full-regression.yml','code-audit-upgrade-from-066.php','Phase gate must rehearse the installed migration 066 to 067 path.');
$need('.github/workflows/package-two-zips.yml','20260924_067_ai_quota_checkout_idempotency.sql','Production package must contain migration 067.');
