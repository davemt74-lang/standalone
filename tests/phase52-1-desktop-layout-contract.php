...
$need('home.php','agent-chat.js?v=41.0','Research Agent close behavior must ship with a fresh cache key.');
$need('home.php','research-agent-workspace-ui.js?v=52.1','Desktop layout behavior must ship with a fresh cache key.');
