...
$history=admin_agent_messages($pdo,$owner,(string)$thread['public_id']);$last=end($history['messages']);av280(count($last['admin_links']??[])===1&&($last['admin_links'][0]['identifier']??'')===$account['public_id'],'Authorized Admin navigation cards persist with the Agent message.');
