...
$api=(string)file_get_contents($root.'/api/extension.php');foreach(['publish','comment','presence','live_message','live_message_delete','live_message_pin','live_react'] as $action)if(!str_contains($api,"'$action'=>"))$fail[]="Extension mutation rate limit missing: $action";
