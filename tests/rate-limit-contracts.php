...
$api=(string)file_get_contents($root.'/api/extension.php');foreach(['publish','comment','presence','live_message','live_message_delete','live_message_pin','live_react','report','notification_read','notification_read_all','notification_archive','notification_mute','search','search_save','search_delete','search_alert','search_add_research'] as $action)if(!str_contains($api,"'$action'=>"))$fail[]="Extension mutation rate limit missing: $action";
