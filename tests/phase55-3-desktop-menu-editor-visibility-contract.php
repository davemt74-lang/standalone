...
foreach([
  ...
  '/assets/css/app.css?v=58.0'=>'Home must request the Phase 58 CSS cache key.',
  '/assets/js/research-agent-workspace-ui.js?v=58.0'=>'Home must request the Phase 58 Research workspace JS cache key.',
