...
foreach([
  ...
  '/assets/css/app.css?v=59.0'=>'Home must request the Phase 59 CSS cache key.',
  '/assets/js/research-agent-workspace-ui.js?v=59.0'=>'Home must request the Phase 59 Research workspace JS cache key.',
