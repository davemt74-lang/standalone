...
try{
    ...
    $pdo->beginTransaction();job_claim_assert($pdo,'research_retrieval_jobs',$id,$token);job_claim_complete($pdo,'research_retrieval_jobs',$id,$token);$pdo->commit();
    release_worker_heartbeat($pdo,'research_retrieval','success','Research retrieval index rebuilt.',1);echo "Research retrieval index rebuilt.\n";
